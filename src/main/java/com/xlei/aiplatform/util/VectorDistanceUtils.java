package com.xlei.aiplatform.util;
...
public class VectorDistanceUtils {
    ...
    /**
     * 计算两个向量的曼哈顿距离(即两个向量在各个维度上差值的绝对值之和)
     * @param vector1 第一个向量
     * @param vector2 第二个向量
     * @return 曼哈顿距离值
     * @throws IllegalArgumentException 如果两个向量维度不同或向量为空
     */
    public static double manhattanDistance(float[] vector1, float[] vector2) {
    ...
    /**
     * 计算余弦距离(即两个向量方向上的相似性,值范围为[-1,1],1表示完全相同，-1表示完全相反)
     *   余弦距离越大,越相似
     * @param vectorA 向量A（非空且与B等长）
     * @param vectorB 向量B（非空且与A等长）
     * @return 余弦距离，范围[0, 2]
